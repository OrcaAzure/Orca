...
fun HexScreen(
    ...
    viewModel: HexViewModel = hiltViewModel(),
) {
    val input by viewModel.input.collectAsStateWithLifecycle()
    val mode by viewModel.mode.collectAsStateWithLifecycle()
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    ToolScaffold(title = "Hex", onBack = onBack, modifier = modifier) {
        Text(
            text = "Offline hex encode/decode",
        ...
        OrcaTextField(
            ...
            label = "Input",
            placeholder = "Text or hex string",
            singleLine = false,
